...
const Footer = () => {
  return (
    <footer className="my-20 flex justify-between items-start flex-wrap gap-y-5">
      <div className="flex justify-start items-start text-md flex-wrap gap-y-5">
        <div className="w-[200px] text-sidebar_text mr-6">
          <ul>
            <li>
            ...
            <li className="my-2">
              <a
                className="hover:underline hover:text-white duration-300 "
                href="#"
              >
                About
              </a>
      ...
      <div className="flex justify-center items-center gap-5">
        <div className="w-10 h-10 rounded-full bg-social_bg flex justify-center items-center duration-300 cursor-pointer hover:bg-sidebar_text">
          <a href="#">
            <svg
              role="img"
              aria-hidden="true"
      ...
      <hr className="text-sidebar_text opacity-30 block w-full" />

      <div className="flex justify-between items-center w-full text-sm text-sidebar_text">
