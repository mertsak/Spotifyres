    ...
    <div className="flex flex-col justify-center pt-10 pb-20 items-center w-[450px] mx-auto text-center">
      ...
      <div className="mb-8 w-full flex flex-col justify-center items-center">
        ...
        <svg
          ...
          className="fill-black w-[150px] h-[40px] "
        >
          <title>Spotify</title>
      ...
      <div className="flex flex-col justify-center items-center w-full gap-6 mb-4">
        <button className="w-[90%] bg-facebook border-white border-solid border-2 rounded-full py-3 px-6 flex justify-center items-center gap-5 hover:scale-105 duration-300">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          <span>Facebook ile kaydol</span>
        </button>

        <button className="w-[90%] border-black border-solid border-2 rounded-full py-3 px-6 flex justify-center items-center gap-5 hover:scale-105 duration-300">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          <span className="text-black">Google ile kaydol</span>
        </button>
      </div>

      <div class="inline-flex items-center justify-center w-full">
        <hr class="w-[85%] h-px my-8 bg-gray-500 border-0" />
        <span class="absolute px-3 font-light text-gray-500 tracking-widest -translate-x-1/2 bg-white left-1/2 ">
          veya
        </span>
      </div>
